...
const sections = [{"key":"suppliers","label":"Suppliers","cols":["Code","Name","Phone"],"keys":["supplier_code","supplier_name","telephone"]},{"key":"shipments","label":"Shipments","cols":["Number","Date","Status","Destination"],"keys":["shipment_number","shipment_date","shipment_status","destination"]},{"key":"deliveries","label":"Deliveries","cols":["Code","Date","Qty","Status"],"keys":["delivery_code","delivery_date","quantity_delivered","delivery_status"]}];
