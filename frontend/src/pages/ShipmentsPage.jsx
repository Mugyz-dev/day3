...
const fields = [{"key":"shipmentNumber","col":"shipment_number","label":"Shipment Number","required":true},{"key":"shipmentDate","col":"shipment_date","label":"Shipment Date","type":"datetime-local","required":true},{"key":"shipmentStatus","col":"shipment_status","label":"Status","required":true},{"key":"destination","col":"destination","label":"Destination","required":true},{"key":"supplierCode","col":"supplier_code","label":"Supplier Code","required":true}];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted text-sm">Manage shipment with full CRUD</p>
      </div>
