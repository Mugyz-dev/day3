...
const fields = [{"key":"supplierCode","col":"supplier_code","label":"Supplier Code","required":true},{"key":"supplierName","col":"supplier_name","label":"Supplier Name","required":true},{"key":"telephone","col":"telephone","label":"Telephone","required":true},{"key":"address","col":"address","label":"Address","required":true},{"key":"email","col":"email","label":"Email","required":true}];
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={submit} className="bg-card rounded-xl border border-line p-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-2 flex gap-3 items-center">
          <button type="submit" disabled={loading} className="rounded-lg bg-accent text-accent-text px-5 py-2 font-semibold">{loading ? "Saving..." : "Add Supplier"}</button>
